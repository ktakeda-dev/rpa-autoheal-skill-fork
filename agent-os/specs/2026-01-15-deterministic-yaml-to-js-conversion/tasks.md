...
- [ ] 1.0 スキーマ定義の完成
  - [ ] 1.1 スキーマ検証用テストを2-8件作成
    - 有効なYAMLが検証を通過することを確認
    - 無効なYAMLが適切なエラーを返すことを確認
    - `when`句の構造化形式の検証テスト
    - `hint`フィールドの配置検証テスト
  - [ ] 1.2 ワークフロースキーマの基本構造を定義
